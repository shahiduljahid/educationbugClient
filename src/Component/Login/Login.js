...
import google from "../../photos/search.png"
import coverPhoto from "../../photos/2333625.jpg"
      ...
      <div className="row justify-content-between">
        ...
        >
          ...
          >
            ...
            <input
              className="btn mb-3  btn-color text-white button-color text-bold text-bold button form-group form-control p-2"
              type="submit"
            ...
            {!newUser && (
              <p>
                ...
                <button
                  ...
                  className="btn mb-3 button-color text-bold text-white text-bold  btn-color ml-2"
                >
                  create account
                </button>
              </p>
        ...
        <img src={coverPhoto} alt="" class="img-fluid"/>
